...
from app.models import (
    ...
    Trainer, HeldItem, Trainer_HeldItem, PokemonInstance, Team, Nature, Type
)
...
def seed_database():
    with app.app_context():
        ...
        # ===== NATURES =====
        natures_data = [
            ("N1", "Adamant", "Attack", "Special Attack"),
            ("N2", "Modest", "Special Attack", "Attack"),
            ("N3", "Timid", "Speed", "Attack"),
            ("N4", "Jolly", "Speed", "Special Attack"),
            ("N5", "Calm", "Special Defense", "Attack"),
            ("N6", "Bold", "Defense", "Attack"),
            ("N7", "Careful", "Special Defense", "Special Attack"),
            ("N8", "Quiet", "Special Attack", "Speed"),
            ("N9", "Brave", "Attack", "Speed"),
            ("N10", "Hasty", "Speed", "Defense"),
            ("N11", "Impish", "Defense", "Special Attack"),
            ("N12", "Lax", "Defense", "Special Defense"),
            ("N13", "Lonely", "Attack", "Defense"),
            ("N14", "Mild", "Special Attack", "Defense"),
            ("N15", "Rash", "Special Attack", "Special Defense"),
            ("N16", "Relaxed", "Defense", "Speed"),
            ("N17", "Sassy", "Special Defense", "Speed"),
            ("N18", "Serious", None, None),
        ]
        for nature_id, name, increased_stat, decreased_stat in natures_data:
            nature = Nature(id=nature_id, name=name, increased_stat=increased_stat, decreased_stat=decreased_stat)
            db.session.add(nature)

        db.session.commit()
        print(f"✓ Added {len(natures_data)} natures")
        ...
        db.session.commit()
        print(f"✓ Added {len(types_data)} types")
        ...
        for poke_id, name, variant, hp, att, defense, sp_att, sp_def, speed, type1, type2, is_base in pokemon_data:
            pokemon = PokemonSpecies(
                ...
                speed=speed, type1=type1, type2=type2, is_base_form=is_base
            )
        ...
        pokemon_instances_data = [
            ...
            ("PI1", "3", "T1", 11, 11, 11, 11, 11, 11, "N5", "A1", "M4", "M58", "M44", "M111"),
            ("PI2", "3", "T2", 22, 0, 11, 11, 22, 0, "N8", "A29", "M58", "M44", "M111", "M59"),
            
            # Charizard
            ("PI3", "6", "T3", 0, 22, 11, 0, 11, 22, "N1", "A2", "M2", "M7", "M96", "M89"),
            ("PI4", "6", "T4", 11, 11, 0, 22, 11, 11, "N2", "A7", "M7", "M96", "M89", "M26"),
            
            # Blastoise
            ("PI5", "9", "T5", 11, 0, 22, 11, 11, 11, "N3", "A3", "M3", "M20", "M62", "M14"),
            ("PI6", "9", "T6", 22, 11, 11, 0, 11, 11, "N4", "A6", "M20", "M62", "M14", "M39"),
            
            # Raichu
            ("PI7", "26", "T7", 0, 11, 11, 11, 22, 11, "N5", "A5", "M5", "M25", "M38", "M75"),
            ("PI8", "26", "T8", 11, 22, 0, 11, 11, 11, "N6", "A11", "M25", "M38", "M75", "M53"),
            
            # Arcanine
            ("PI9", "59", "T9", 0, 22, 11, 11, 11, 11, "N7", "A7", "M2", "M7", "M96", "M25"),
            ("PI10", "59", "T10", 11, 11, 22, 0, 11, 11, "N8", "A40", "M7", "M96", "M25", "M26"),
            
            # Steelix
            ("PI11", "208", "T11", 11, 11, 22, 0, 11, 11, "N9", "A19", "M144", "M138", "M143", "M13"),
            ("PI12", "208", "T12", 0, 22, 11, 11, 11, 11, "N10", "A38", "M138", "M143", "M13", "M96"),
            
            # Dragonite
            ("PI13", "149", "T1", 11, 22, 11, 0, 11, 11, "N11", "A9", "M89", "M43", "M44", "M19"),
            ("PI14", "149", "T2", 11, 11, 0, 11, 22, 11, "N12", "A39", "M19", "M44", "M89", "M26"),
            
            # Vaporeon
            ("PI15", "134", "T3", 22, 0, 11, 11, 11, 11, "N13", "A15", "M3", "M20", "M55", "M62"),
            ("PI16", "134", "T4", 11, 11, 11, 22, 0, 11, "N14", "A35", "M20", "M55", "M62", "M39"),
            
            # Jolteon
            ("PI17", "135", "T5", 0, 11, 11, 11, 11, 22, "N15", "A5", "M5", "M75", "M27", "M38"),
            ("PI18", "135", "T6", 11, 11, 22, 11, 0, 11, "N16", "A11", "M75", "M27", "M38", "M53"),
            
            # Flareon
            ("PI19", "136", "T7", 0, 22, 11, 11, 11, 11, "N17", "A2", "M2", "M7", "M39", "M25"),
            ("PI20", "136", "T8", 11, 11, 0, 22, 11, 11, "N18", "A40", "M7", "M39", "M25", "M26"),
            
            # Espeon
            ("PI21", "196", "T9", 11, 0, 11, 22, 11, 11, "N10", "A29", "M15", "M46", "M26", "M47"),
            ("PI22", "196", "T10", 11, 11, 22, 11, 0, 11, "N8", "A13", "M46", "M26", "M47", "M39"),
            
            # Umbreon
            ("PI23", "197", "T11", 11, 11, 22, 0, 11, 11, "N7", "A23", "M144", "M123", "M141", "M43"),
            ("PI24", "197", "T12", 0, 11, 11, 11, 22, 11, "N15", "A13", "M123", "M141", "M43", "M26"),
            
            # Articuno
            ("PI25", "144", "T1", 11, 11, 11, 11, 22, 0, "N3", "A51", "M8", "M62", "M95", "M47"),
            ("PI26", "144", "T2", 0, 11, 22, 11, 11, 11, "N8", "A12", "M62", "M95", "M47", "M39"),
            
            # Zapdos
            ("PI27", "145", "T3", 11, 0, 11, 22, 11, 11, "N4", "A51", "M5", "M75", "M26", "M47"),
            ("PI28", "145", "T4", 11, 11, 0, 11, 22, 11, "N5", "A42", "M75", "M26", "M47", "M39"),
            
            # Moltres
            ("PI29", "146", "T5", 11, 22, 11, 0, 11, 11, "N6", "A51", "M7", "M76", "M26", "M47"),
            ("PI30", "146", "T6", 0, 11, 11, 11, 22, 11, "N7", "A40", "M76", "M26", "M47", "M39"),
            
            # Mewtwo
            ("PI31", "150", "T7", 11, 0, 11, 22, 11, 11, "N1", "A25", "M15", "M19", "M43", "M26"),
            ("PI32", "150", "T8", 11, 11, 0, 11, 22, 11, "N2", "A29", "M19", "M43", "M26", "M39"),
            
            # Tyranitar
            ("PI33", "248", "T9", 11, 22, 11, 0, 11, 11, "N17", "A7", "M144", "M57", "M143", "M43"),
            ("PI34", "248", "T10", 0, 11, 11, 22, 11, 11, "N13", "A48", "M57", "M143", "M43", "M39"),
            
            # Lugia
            ("PI35", "249", "T11", 11, 0, 22, 11, 11, 11, "N8", "A51", "M20", "M15", "M90", "M43"),
            ("PI36", "249", "T12", 11, 11, 11, 22, 0, 11, "N9", "A39", "M15", "M90", "M43", "M39"),
            
            # Ho-Oh
            ("PI37", "250", "T1", 11, 22, 11, 0, 11, 11, "N10", "A51", "M7", "M20", "M90", "M43"),
            ("PI38", "250", "T2", 0, 11, 11, 22, 11, 11, "N11", "A40", "M20", "M90", "M43", "M39"),
            
            # Rayquaza
            ("PI39", "384", "T3", 11, 22, 0, 11, 11, 11, "N1", "A9", "M89", "M19", "M90", "M44"),
            ("PI40", "384", "T4", 11, 11, 11, 22, 0, 11, "N2", "A39", "M19", "M90", "M44", "M39"),
            
            # Garchomp
            ("PI41", "445", "T5", 11, 22, 11, 0, 11, 11, "N3", "A56", "M144", "M89", "M44", "M45"),
            ("PI42", "445", "T6", 0, 11, 11, 22, 11, 11, "N4", "A57", "M89", "M44", "M45", "M39"),
            
            # Dialga
            ("PI43", "483", "T7", 11, 11, 22, 11, 0, 11, "N5", "A22", "M144", "M90", "M43", "M13"),
            ("PI44", "483", "T8", 11, 22, 11, 0, 11, 11, "N6", "A38", "M90", "M43", "M13", "M96"),
            
            # Palkia
            ("PI45", "484", "T9", 11, 0, 11, 22, 11, 11, "N12", "A22", "M20", "M90", "M43", "M19"),
            ("PI46", "484", "T10", 11, 11, 0, 11, 22, 11, "N13", "A39", "M90", "M43", "M19", "M39"),
            
            # Heatran
            ("PI47", "485", "T11", 11, 11, 22, 11, 0, 11, "N14", "A17", "M7", "M144", "M13", "M96"),
            ("PI48", "485", "T12", 0, 11, 11, 22, 11, 11, "N15", "A40", "M144", "M13", "M96", "M39"),
            
            # Giratina
            ("PI49", "487", "T1", 11, 11, 11, 0, 22, 11, "N8", "A25", "M17", "M43", "M19", "M26"),
            ("PI50", "487", "T2", 0, 11, 22, 11, 11, 11, "N9", "A29", "M43", "M19", "M26", "M39"),
            
            # Cresselia
            ("PI51", "488", "T3", 11, 0, 11, 11, 22, 11, "N16", "A30", "M46", "M49", "M41", "M30"),
            ("PI52", "488", "T4", 11, 11, 22, 11, 0, 11, "N17", "A39", "M49", "M41", "M30", "M39"),
            
            # Reshiram
            ("PI53", "643", "T5", 11, 11, 0, 22, 11, 11, "N1", "A40", "M89", "M19", "M7", "M44"),
            ("PI54", "643", "T6", 0, 22, 11, 11, 11, 11, "N2", "A39", "M19", "M7", "M44", "M45"),
            
            # Zekrom
            ("PI55", "644", "T7", 11, 22, 11, 0, 11, 11, "N3", "A42", "M89", "M19", "M5", "M44"),
            ("PI56", "644", "T8", 11, 11, 0, 22, 11, 11, "N4", "A42", "M19", "M5", "M44", "M39"),
            
            # Tornadus
            ("PI57", "645", "T9", 0, 11, 11, 11, 11, 22, "N17", "A48", "M95", "M44", "M26", "M53"),
            ("PI58", "645", "T10", 11, 11, 22, 11, 0, 11, "N18", "A49", "M44", "M26", "M53", "M39"),
            
            # Keldeo
            ("PI59", "647", "T11", 11, 11, 11, 22, 0, 11, "N16", "A9", "M18", "M20", "M44", "M11"),
            ("PI60", "647", "T12", 0, 11, 22, 11, 11, 11, "N15", "A39", "M20", "M44", "M11", "M45"),
            
            # Aegislash
            ("PI61", "681", "T1", 11, 0, 22, 11, 11, 11, "N14", "A56", "M13", "M43", "M143", "M26"),
            ("PI62", "681", "T2", 11, 11, 11, 0, 22, 11, "N13", "A57", "M43", "M143", "M26", "M39"),
            
            # Trevenant
            ("PI63", "689", "T3", 11, 22, 11, 0, 11, 11, "N1", "A23", "M17", "M43", "M58", "M29"),
            ("PI64", "689", "T4", 0, 11, 11, 22, 11, 11, "N2", "A29", "M43", "M58", "M29", "M39"),
            
            # Carbink
            ("PI65", "703", "T5", 11, 11, 22, 0, 11, 11, "N16", "A22", "M143", "M120", "M43", "M46"),
            ("PI66", "703", "T6", 0, 11, 11, 11, 22, 11, "N17", "A38", "M120", "M43", "M46", "M39"),
            
            # Zygarde
            ("PI67", "718", "T7", 11, 22, 11, 0, 11, 11, "N1", "A9", "M89", "M90", "M144", "M44"),
            ("PI68", "718", "T8", 11, 11, 0, 22, 11, 11, "N2", "A39", "M90", "M144", "M44", "M39"),
            
            # Gumshoos
            ("PI69", "735", "T9", 0, 22, 11, 11, 11, 11, "N11", "A41", "M141", "M101", "M86", "M123"),
            ("PI70", "735", "T10", 11, 11, 22, 0, 11, 11, "N12", "A44", "M101", "M86", "M123", "M39"),
            
            # Turtonator
            ("PI71", "776", "T11", 11, 11, 0, 22, 11, 11, "N14", "A2", "M7", "M19", "M96", "M26"),
            ("PI72", "776", "T12", 11, 22, 11, 0, 11, 11, "N13", "A40", "M19", "M96", "M26", "M45"),
            
            # Kommo-o
            ("PI73", "784", "T1", 11, 22, 11, 0, 11, 11, "N3", "A51", "M11", "M89", "M19", "M44"),
            ("PI74", "784", "T2", 0, 11, 11, 22, 11, 11, "N4", "A39", "M89", "M19", "M44", "M39"),
            
            # Tapu Koko
            ("PI75", "785", "T3", 0, 11, 11, 11, 11, 22, "N5", "A42", "M5", "M120", "M26", "M47"),
            ("PI76", "785", "T4", 11, 22, 11, 0, 11, 11, "N6", "A48", "M120", "M26", "M47", "M45"),
            
            # Tapu Lele
            ("PI77", "786", "T5", 11, 0, 11, 22, 11, 11, "N7", "A25", "M15", "M120", "M26", "M46"),
            ("PI78", "786", "T6", 11, 11, 0, 11, 22, 11, "N8", "A29", "M120", "M26", "M46", "M39"),
            
            # Tapu Bulu
            ("PI79", "787", "T7", 11, 22, 11, 0, 11, 11, "N9", "A26", "M91", "M58", "M44", "M45"),
            ("PI80", "787", "T8", 0, 11, 11, 22, 11, 11, "N10", "A27", "M58", "M44", "M45", "M39"),
            
            # Tapu Fini
            ("PI81", "788", "T9", 11, 0, 11, 11, 22, 11, "N11", "A15", "M20", "M120", "M26", "M46"),
            ("PI82", "788", "T10", 11, 11, 22, 11, 0, 11, "N12", "A35", "M120", "M26", "M46", "M39"),
            
            # Necrozma
            ("PI83", "800", "T11", 11, 11, 0, 22, 11, 11, "N13", "A56", "M15", "M19", "M43", "M26"),
            ("PI84", "800", "T12", 0, 11, 22, 11, 11, 11, "N14", "A29", "M19", "M43", "M26", "M39"),
            
            # Urshifu
            ("PI85", "812", "T1", 11, 22, 11, 0, 11, 11, "N15", "A56", "M11", "M21", "M26", "M45"),
            ("PI86", "812", "T2", 0, 11, 11, 22, 11, 11, "N16", "A57", "M21", "M26", "M45", "M39"),
            
            # Sobble
            ("PI87", "816", "T3", 11, 0, 11, 11, 22, 11, "N17", "A3", "M3", "M20", "M62", "M14"),
            ("PI88", "816", "T4", 11, 11, 0, 11, 22, 11, "N18", "A6", "M20", "M62", "M14", "M39"),
            
            # Corviknight
            ("PI89", "823", "T5", 0, 11, 22, 11, 11, 11, "N1", "A42", "M95", "M144", "M143", "M25"),
            ("PI90", "823", "T6", 11, 11, 11, 0, 22, 11, "N2", "A19", "M144", "M143", "M25", "M39"),
            
            # Drednaw
            ("PI91", "834", "T7", 11, 22, 11, 0, 11, 11, "N3", "A7", "M14", "M143", "M20", "M97"),
            ("PI92", "834", "T8", 0, 11, 11, 22, 11, 11, "N4", "A44", "M143", "M20", "M97", "M39"),
            
            # Hatterene
            ("PI93", "858", "T9", 11, 0, 11, 22, 11, 11, "N5", "A25", "M15", "M120", "M26", "M46"),
            ("PI94", "858", "T10", 11, 11, 0, 11, 22, 11, "N6", "A29", "M120", "M26", "M46", "M39"),
            
            # Cptain
            ("PI95", "879", "T11", 11, 11, 11, 22, 0, 11, "N7", "A29", "M15", "M19", "M43", "M26"),
            ("PI96", "879", "T12", 0, 11, 22, 11, 11, 11, "N8", "A55", "M19", "M43", "M26", "M39"),
            
            # Dragapult
            ("PI97", "887", "T1", 0, 11, 11, 11, 11, 22, "N9", "A9", "M89", "M90", "M19", "M44"),
            ("PI98", "887", "T2", 11, 22, 11, 0, 11, 11, "N10", "A39", "M90", "M19", "M44", "M45"),
            
            # Calyrex
            ("PI99", "898", "T3", 11, 0, 11, 22, 11, 11, "N11", "A29", "M15", "M44", "M41", "M26"),
            ("PI100", "898", "T4", 11, 11, 0, 11, 22, 11, "N12", "A25", "M44", "M41", "M26", "M39"),
            
            # Enamorus
            ("PI101", "905", "T5", 0, 11, 11, 11, 11, 22, "N13", "A48", "M95", "M44", "M26", "M120"),
            ("PI102", "905", "T6", 11, 22, 11, 0, 11, 11, "N14", "A49", "M44", "M26", "M120", "M45"),
            
            # Palafin (base form only)
            ("PI103", "964", "T7", 11, 0, 11, 11, 22, 11, "N15", "A58", "M3", "M20", "M55", "M8"),
            ("PI104", "964", "T8", 11, 11, 0, 11, 22, 11, "N16", "A58", "M20", "M55", "M8", "M39"),
        ]
        
        for inst_id, species_id, trainer_id, hp_ev, att_ev, def_ev, sp_att_ev, sp_def_ev, spd_ev, nature_id, ability_id, move1, move2, move3, move4 in pokemon_instances_data:
            instance = PokemonInstance(
                ...
                nature_id=nature_id, ability_id=ability_id,
